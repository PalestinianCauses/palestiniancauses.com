    ...
    <main className="section-padding-start-lg">
      ...
      <Frame
        ...
        <FrameContent className="font-[ShamelSansOne]">
          <SectionTitle className="my-32 mb-0 font-[inherit] font-bold !leading-tight text-amber-950">
            مِن أرضٍ <br />
            <FrameHighlight className="font-[inherit] font-bold before:-inset-x-2.5 before:bottom-2.5 before:top-[initial] before:h-1/2 before:bg-amber-500 before:ring-amber-500">
              بعيــــــــــــدةٍ،
            </FrameHighlight>
          </SectionTitle>
        </FrameContent>
      ...
      <Frame
        ...
        <FrameContent className="font-[ShamelSansOne]">
          <SectionTitle className="my-32 mb-0 font-[inherit] font-bold !leading-tight text-amber-950">
            ...
            <FrameHighlight className="font-[inherit] font-bold text-amber-100 before:-inset-x-2.5 before:bottom-2.5 before:top-[initial] before:h-1/2 before:bg-amber-950 before:ring-amber-950">
              غــــــــــــزَّة
            </FrameHighlight>{" "}
            فِي ترابِها الطاهِر،
          </SectionTitle>
