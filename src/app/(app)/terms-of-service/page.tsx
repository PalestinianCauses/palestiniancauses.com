        ...
        <section
          ...
          <div className="flex flex-col items-start gap-2">
            <h1
              ...
              PalestinianCauses LLC Terms Of Service.
            </h1>
          </div>
          <div className="flex flex-col gap-10 text-lg/9 text-muted-foreground">
            ...
            <p>
              ...
              Service will take effect immediately after publication.
            </p>
            <p>These Terms of Service were last updated on January 9, 2025.</p>
            ...
            <ol className="flex list-decimal flex-col gap-3">
              ...
              <li>
                Remove copyright or other proprietary notations from any
              ...
              <li>
                ...
                networks or any other service PalestinianCauses LLC provides.
              </li>
              <li>
            ...
            <p>
              ...
              website are owned by or licensed to PalestinianCauses LLC and are
            ...
            <p>
              ...
              by PalestinianCauses LLC at any time.
            </p>
            <h2 className="mt-6 text-3xl font-semibold text-foreground">
            ...
            <p>
              The license you grant us can be terminated anytime by deleting
              ...
              sponsored content, the license will continue until we have
              discontinued the relevant commercial or post.
            </p>
            <p>
              You permit us to use your username and other identifying
              information associated with your account in a manner consistent
            ...
            <p>
              ...
              PalestinianCauses LLC makes no warranties, expressed or implied,
            ...
            <p>
              ...
              or the materials on this website, even if PalestinianCauses LLC or
            ...
            <p>
              ...
              are for general information purposes only. PalestinianCauses LLC
            ...
            <p>
              ...
              you to conduct your investigations concerning the suitability of
              those sites.
            </p>
            <h2 className="mt-6 text-3xl font-semibold text-foreground">
              Right to Terminate.
            ...
            <p>
              Any term of these Terms of Service that is wholly or partially
            ...
            <p>
              These Terms of Service are governed by and construed by the laws
              of the USA. You irrevocably submit to the exclusive jurisdiction
