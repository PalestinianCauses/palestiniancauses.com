...
export const AchievementsList = function AchievementsList({
  userId,
}: {
  userId: number;
}) {
      ...
      {achievementsGained.length !== 0 ? (
        ...
        <div className="mx-auto flex max-w-4xl flex-col items-center justify-center pt-10 text-center">
          ...
          <Paragraph small className="mb-6 lg:mb-12">
            There are currently no achievements available for this user. Explore
            other profiles or check back soon to discover new accomplishments.
          </Paragraph>
        </div>
      )}
    </div>
