  ...
  return toJsxRuntime(tokens, {
    ...
    components: {
      pre: ({ className, style, children, ...propsPre }) => (
        <pre
          className={cn(
            "no-scrollbar !m-0 overflow-x-auto !rounded-none border border-muted/25 !bg-background !p-5 !font-mono !text-base !leading-snug md:text-wrap lg:!text-lg lg:!leading-snug xl:!text-lg xl:!leading-snug",
            className,
          )}
...
export const CodeBlock = async function CodeBlock({
  ...
  return (
    <div className="relative my-[2em] flex w-full flex-col items-stretch gap-2.5 bg-background bg-muted/10 p-2.5">
      <div className="absolute left-0 top-0 flex w-full items-center justify-start gap-2.5">
        ...
        <div className="h-px w-full bg-muted/25" />
      </div>
