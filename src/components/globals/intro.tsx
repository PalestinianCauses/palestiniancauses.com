...
import { withAuthenticationPreFetch } from "../auth/providers";
...
const AuthenticationButtonsWithAuthenticationPreFetch =
  withAuthenticationPreFetch(AuthenticationButtons);

const NotificationButtonWithAuthenticationPreFetch =
  withAuthenticationPreFetch(NotificationButton);
  ...
  return (
    <section className="grid grid-rows-[max-content_1fr_max-content] gap-5 p-5 xl:gap-10 xl:p-10">
      <nav className="flex flex-wrap items-center justify-between gap-5">
        ...
        <AuthenticationButtonsWithAuthenticationPreFetch />
      </nav>
      ...
      <footer className="flex w-full flex-col flex-wrap justify-start gap-5 xl:flex-row xl:items-end">
        <div className="flex flex-1 flex-col gap-1.5">
          ...
          <NotificationButtonWithAuthenticationPreFetch />
        </div>
