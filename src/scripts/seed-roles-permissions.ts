...
const permissions: Omit<Permission, "id" | "createdAt" | "updatedAt">[] = [
  ...
  {
    name: "media-private.manage",
    resource: "media-private",
    action: "manage",
    description: "Manage private media in admin dashboard",
  },
  {
    name: "media-private.create",
    resource: "media-private",
    action: "create",
    description: "Upload private media files",
  },
  {
    name: "media-private.read",
    resource: "media-private",
    action: "read",
    description: "View private media files",
  },
  {
    name: "media-private.update",
    resource: "media-private",
    action: "update",
    description: "Update private media files",
  },
  {
    name: "media-private.delete",
    resource: "media-private",
    action: "delete",
    description: "Delete private media files",
  },

  {
    name: "media-public.manage",
    resource: "media-public",
    action: "manage",
    description: "Manage public media in admin dashboard",
  },
  {
    name: "media-public.create",
    resource: "media-public",
    action: "create",
    description: "Upload public media files",
  },
  {
    name: "media-public.read",
    resource: "media-public",
    action: "read",
    description: "View public media files",
  },
  {
    name: "media-public.update",
    resource: "media-public",
    action: "update",
    description: "Update public media files",
  },
  {
    name: "media-public.delete",
    resource: "media-public",
    action: "delete",
    description: "Delete public media files",
  },
...
const permissionsRoles: Record<string, string[]> = {
  "admin-user": [
    ...
    "media-private.create",
    "media-private.read",
    "media-private.update",
    "media-private.delete",
    "media-public.manage",
    "media-public.create",
    "media-public.read",
    "media-public.update",
